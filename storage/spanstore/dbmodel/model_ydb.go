...
func (s *Span) StructValue() types.Value {
	return types.StructValue(
		...
		types.StructFieldValue("operation_name", types.OptionalValue(types.TextValue(s.OperationName))),
		...
		types.StructFieldValue("extra", types.OptionalValue(types.BytesValue(s.Extra))),
	)
}
